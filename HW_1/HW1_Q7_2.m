function [locStress, globStress, locStrain, globStrain] = HW1_Q7_2(...
    stressOrStrain, state, globOrLoc,  theta)
...
prop.E1 = 21.3 * 10^3; % ksi
% Transverse in-plane modulus
prop.E2 = 1.5 * 10^3; % ksi
% Major in-palne poisson's ratio
prop.v12 =.27;
% Major in-plane shear modulus
prop.G12 = 1 * 10^3; % ksi
